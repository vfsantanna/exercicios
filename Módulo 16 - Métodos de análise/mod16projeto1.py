...
### [**Projeto #02** | Previsão de renda](https://github.com/vfsantanna/exercicios/blob/73b8b3d9794256039ca5a934d1bb3ea1dc59e44f/Arquivos/previsao_de_renda.csv)

**Por:** [Vivian Sant Anna]<br>
...
with st.sidebar.expander("Bibliotecas/Pacotes", expanded=False):
    ...
    Pacotes apresentam conflito de versões e não puderam ser exibidos
...
st.markdown('# <div style="text-align:center"> [Previsão de renda](https://github.com/vfsantanna/previsao-renda) </div>',
            unsafe_allow_html=True)
...
filepath = 'https://raw.githubusercontent.com/vfsantanna/previsao-de-renda/241a0a136bd9e2c35651c5c875778ecc1d34a1fc/previsao_de_renda%20(3).csv'
...
#    prof = pp.ProfileReport(df=renda,
#                            minimal=False,
#                            explorative=True,
#                            dark_mode=True,
#                            orange_mode=True)
